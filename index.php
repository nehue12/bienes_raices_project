...
<div class="contenedor seccion seccion-inferior">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p>Consejos para construir una terraza en el techo de tu casa con materiales y ahorrando dinero</p>
                </a>
            </div>
        </article>
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    ...
                    <p class="info-meta">Escrito el: <span>19/10/2022</span> por: <span>Admin</span></p>
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comporto excelente, muy buena atención y la casa que me ofrecieron
